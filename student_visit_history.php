...
// Fetch visit history for this student
$visits = [];
$visit_sql = "SELECT v.visit_date, v.symptoms, v.treatment, cs.first_name AS staff_first, cs.middle_name AS staff_middle, cs.last_name AS staff_last FROM visits v LEFT JOIN clinic_staff cs ON v.clinic_staff_id = cs.clinic_id WHERE v.student_id = ? ORDER BY v.visit_date DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Visit History - PDMHS</title>
        ...
        <main class="main-content">
            <div class="header">
                <div class="welcome-section">
                    <div class="welcome-title">Visit History</div>
                    <div class="welcome-subtitle">Review your past clinic visits and treatments</div>
                </div>
            ...
            <div class="dashboard-grid">
                <div class="card">
                    <div class="card-header"><i class="fa fa-history card-icon"></i> <span class="card-title">Your Visit History</span></div>
                    <div class="card-body">
